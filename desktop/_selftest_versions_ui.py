...
class FakeQueue:
    ...
    def enqueue_regenerate(self, entry_id, video_path, transcript_path):
        self.regen_calls.append((entry_id, video_path, transcript_path))
...
if fake_q.regen_calls:
    rid, vpath, tpath = fake_q.regen_calls[0]
